        ...
        <div class="mt-4">
            ...
            <div class="flex items-center gap-4">
                <label class="inline-flex items-center">
                    <input type="radio" name="role" value="student" class="form-radio" {{ old('role', 'student') === 'student' ? 'checked' : '' }}>
                    <span class="ml-2 text-gray-700 dark:text-gray-200">Student</span>
                </label>

                <label class="inline-flex items-center">
                    <input type="radio" name="role" value="teacher" class="form-radio" {{ old('role') === 'teacher' ? 'checked' : '' }}>
